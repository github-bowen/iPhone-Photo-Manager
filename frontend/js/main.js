...
import { applyTranslations } from './i18n.js?v=12';
import { updateStats } from './utils.js?v=12';
import { loadPhotos, resetAndReload, setupInfiniteScroll } from './gallery.js?v=12';
import { loadTimeline, loadLocations, closeMobileSidebar, resetSidebarTimer } from './sidebar.js?v=12';
import { closeModal, renderModalContent } from './modal.js?v=12';
import { initAutoplay } from './autoplay.js?v=12';
